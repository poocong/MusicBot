...
async def start(client, message):
    if len(message.command) > 1:
        if message.command[1] == 'help':
            ...
            await message.reply("Learn to use the MusicBot, Showing help menu, Choose from the below options.",
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/PocongProject'),
